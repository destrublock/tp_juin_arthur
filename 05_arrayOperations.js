...
const sum = (array) => {
    array.reduce((total,newNum)=>total+newNum);
}
...
const findUserById = (array, id) => {
    array.find((user)=>user.id===id);
}

console.log(multiplyByTwo([1,2,3,4,5,6,7,8,9]));
console.log(filterNameStartByA(["Apple","Orange","Avocado","Banana","Potato"]));
